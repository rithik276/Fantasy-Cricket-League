...
from p6 import Ui_ScoreWindow
import sys
from p4 import Ui_OpenWindow
from PyQt5.QtWidgets import QFontDialog, QTextEdit, QFileDialog, QListWidget
from p3 import Ui_Form as Form
from p5 import Ui_EvaluateWindow as Box
import numpy as np
import sqlite3
...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        font.setWeight(75)
        self.WICKETKEEPER.setFont(font)
        self.WICKETKEEPER.setObjectName("Wicketkeper")
        ...
        self.Team.addWidget(self.listWidget_2)
        self.listWidget = QtWidgets.QListWidget(self.centralwidget)
        self.listWidget.setObjectName("listWidget")
        self.Team.addWidget(self.listWidget)
        self.verticalLayout.addLayout(self.Team)
        MainWindow.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(MainWindow)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 945, 24))
    ...
    def error(self):
        ...
        if self.totalcount>=0 and self.totalcount<12:
            ...
            error_dialog.showMessage('more than 11 Players are not allowed')
            error_dialog.exec_()
